...
interface IRewardsAggregator {
    ...
    event MerkleClaimed(address indexed stakingProvider, uint256 amount, address beneficiary, bytes32 merkleRoot);
    ...
    function cumulativeMerkleClaimed(address stakingProvider) external view returns(uint256);
