...
export type TACoOperator_orderBy = 'id' | 'operator' | 'bondedTimestamp' | 'bondedTimestampFirstOperator';
...
export type MeshContext = DevelopmentThresholdSubgraphTypes.Context & BaseMeshContext;
